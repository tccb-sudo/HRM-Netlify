...
const FUNCTION_VERSION = "HRM_NETLIFY_PROXY_1.1.0";
const ALLOWED_ACTIONS = new Set(["login","login-with-dept","me","logout","leave-request","leave-requests","approve","reject","hr-confirm","hr-return","create-return","hr-confirm-return","hr-reject-return","stats","employee-leave-info","employees","create-employee","update-employee","import-employees","holiday-settings","save-holiday","delete-holiday","ping"]);
