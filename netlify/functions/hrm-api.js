...
const FUNCTION_VERSION = "HRM_NETLIFY_PROXY_2.2.0";
const ALLOWED_ACTIONS = new Set(["login","login-with-dept","me","logout","leave-request","leave-balance","leave-requests","approve","reject","hr-confirm","hr-return","create-return","hr-confirm-return","hr-reject-return","stats","employee-leave-info","employees","create-employee","update-employee","import-employees","organization-tree","save-organization","assign-role","delete-organization","revoke-role","delete-employee","admin-update-leave","admin-delete-leave","holiday-settings","save-holiday","delete-holiday","ping"]);
