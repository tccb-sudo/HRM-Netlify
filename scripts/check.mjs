...
const fn = await import(new URL("../functions/api/apps-script.js", import.meta.url));
if (typeof fn.onRequest !== "function") throw new Error("Cloudflare Pages Function không hợp lệ");
...
if (!gas.includes("HRM_ENTERPRISE_2.2.4")) throw new Error("Apps Script chưa phải phiên bản Enterprise V2.2.4");
...
console.log("Kiểm tra mã Cloudflare Pages thành công.");
